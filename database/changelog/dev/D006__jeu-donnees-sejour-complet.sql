...
--changeset campement:D006-jeu-donnees-sejour-complet context:dev splitStatements:true endDelimiter:;
--comment: Jeu de test complet sur cinq jours pour les parcours locaux d'intendance
