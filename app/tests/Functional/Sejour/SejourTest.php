...
final class SejourTest extends WebTestCase
{
    ...
    public function testUnAdministrateurPeutDupliquerToutesLesDonneesIntendance(): void
    {
        ...
        $db->executeStatement('INSERT INTO campement.mouvement_stock_ligne (id,mouvement_stock_id,denree_id,conditionnement_saisie_id,quantite_saisie) VALUES (uuidv7(),:mouvement,:denree,:unite,3)', ['mouvement' => $mouvementId, 'denree' => $denree['id'], 'unite' => $denree['unite_inventaire_id']]);
        $client->loginUser($admin);
