...
class Participant
{
    ...
    public function setDateNaissance(\DateTimeImmutable $date): self
    {
    ...
    public function setTelephone(?string $valeur): self
    {
    ...
    public function setEmail(?string $valeur): self
    {
        $this->email = $valeur;
    ...
    public function setTelephoneParent1(?string $valeur): self
    {
        $this->telephoneParent1 = $valeur;
    ...
    public function setTelephoneParent2(?string $valeur): self
    {
        $this->telephoneParent2 = $valeur;
    ...
    public function setEmailParents(?string $valeur): self
    {
        $this->emailParents = $valeur;

        return $this;
    }

    public function getContactUrgenceNomPrenom(): ?string
    {
        return $this->contactUrgenceNomPrenom;
    }

    public function setContactUrgenceNomPrenom(?string $valeur): self
    {
        $this->contactUrgenceNomPrenom = $valeur;
    ...
    public function setContactUrgenceTelephone(?string $valeur): self
    {
        $this->contactUrgenceTelephone = $valeur;
    ...
    /** @param list<string> $valeur */
    public function setQualifications(array $valeur): self
    {
        $this->qualifications = $valeur;

        return $this;
    }

    public function getAutreDiplome(): ?string
    {
        return $this->autreDiplome;
    }

    public function setAutreDiplome(?string $valeur): self
    {
        $this->autreDiplome = $valeur;

        return $this;
    }

    public function isStagiaireBafa(): bool
    {
        return $this->stagiaireBafa;
    }
    ...
    public function setDateDebutPresence(\DateTimeImmutable $date): self
    {
        $this->dateDebutPresence = $date;
    ...
    public function setDateFinPresence(\DateTimeImmutable $date): self
    {
        $this->dateFinPresence = $date;

        return $this;
    }

    /** @return Collection<int, DocumentParticipant> */
