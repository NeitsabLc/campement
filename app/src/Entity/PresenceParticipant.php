...
class PresenceParticipant
{
    ...
    public function setParticipant(Participant $v): self
    {
        $this->participant = $v;
    ...
    public function getDatePresence(): \DateTimeImmutable
    {
        return $this->datePresence;
    }

    public function setDatePresence(\DateTimeImmutable $v): self
    {
        $this->datePresence = $v;
    ...
    public function setCommentaire(?string $v): self
    {
        $this->commentaire = $v;
    ...
    public function actualiser(): self
    {
