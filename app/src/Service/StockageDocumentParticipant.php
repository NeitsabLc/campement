...
final class StockageDocumentParticipant
{
    ...
    public function stocker(UploadedFile $fichier): string
    {
        ...
        if (null === $extension) throw new RuntimeException('Type de fichier non autorisé.');
    ...
    {
        if (basename($nomStockage) !== $nomStockage) throw new RuntimeException('Chemin de document invalide.');
